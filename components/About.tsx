            ...
            <section className="bg-[#F2FCF8]">
                <div className="container mx-auto pt-10 pb-28 px-4 flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:w-1/2 md:pl-10 text-center md:text-left abt-fnt">
                        <h2 className="text-4xl sm:text-4xl md:text-5xl lg:text-8xl pb-10 text-black">
                            Fashion Model & Designer
                        </h2>
                        <p className="text-gray-600 mb-4 text-lg sm:text-xl md:text-1xl lg:text-2xl">
                        ...
                        <p className="text-gray-600 text-lg sm:text-xl md:text-1xl lg:text-2xl ">
                            Based in Trinidad, I am available for shoots and I am eager to explore opportunities locally, regionally & internationally. My goal is to bring each brand's unique vision to life through my adaptability, professionalism, and commitment to embodying its identity and aesthetic.
                        </p>
